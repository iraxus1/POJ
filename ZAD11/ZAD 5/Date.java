...
public class Date {
    ...
    {
        panel.add(label, gbc(1, 1, 1));
        textField.addActionListener(this::userDate);
        panel.add(textField, gbc(1, 1, 1));
    }
    ...
    private void userDate(ActionEvent e) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, localDate.getDayOfWeek().getDisplayName(TextStyle.FULL, Locale.ENGLISH));
        } catch (DateTimeParseException parseException) {
            JOptionPane.showMessageDialog(null, parseException.getMessage(), "ERROR", JOptionPane.ERROR_MESSAGE);
        }
    }

    private void initializeFrame()
    {
        mainFrame.setTitle("Name of the day");
